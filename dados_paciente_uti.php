...
$select_nome = "SELECT nome_paci_inte 
...
<meta charset="UTF-8">
  ...
  <body>
    ...
    <div>
		...
		$select_exibe_paciente ="SELECT paciente_internado.pk_paci_inte,
...
<a href = "altera_dados_uti.php?unknow=<?php echo $pk; ?>" class="btn btn-outline-danger" style = "margin-bottom: 0px; margin-left: 940px">EDITAR</a>
<a href = "exclui_dados_uti.php?unknow=<?php echo $pk; ?>" class="btn btn-outline-danger">EXCLUIR</a>
	...
	<table class="table table-hover" style="margin-bottom:30px">
		...
		<tbody>	
			<tr align = "center">
				<td><?php echo ' '.$row_markers['nome_paci_inte']; ?></td>
				<td><?php echo ' '.$row_markers['cpf_paci_inte']; ?></td>
				<td><?php echo ' '.$row_markers['fone_paci_inte'];?></td>
			</tr>
		</tbody>	
	...
	<table class="table table-hover">
		...
		<tbody>
			<tr align = "center">
				<td><?php echo ' '.$row_markers['logr_ende_paci_inte']; ?></td>
				<td><?php echo ' '.$row_markers['nume_ende_paci_inte']; ?></td>
				<td><?php echo ' '.$row_markers['cida_ende_paci_inte'];?></td>
				<td><?php echo ' '.$row_markers['bair_ende_paci_inte'];?></td>
				<td><?php echo ' '.$row_markers['cep_ende_paci_inte'];?></td>
			</tr>	
		</tbody>	
	</table>
	...
	<table class="table table-hover">
		<thead style = "background-color: #B22222; color: white;">
				<tr align = "center">
					...
					<th scope = "row" style = "background-color: #B22222; color: white; Width:150px;">Estado do Paciente</th>
				</tr>
		</thead>
		...
		<tbody>	
				...
				<td><?php echo ' '.date("d/m/Y", strtotime($row_markers['data_entr_paci_inte']));?></td>
				<td><?php echo ' '.$row_markers['esta_doen']; ?></td></tr>
									<?php
