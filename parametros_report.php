...
$select_cidade = "SELECT DISTINCT cida_ende_paci FROM endereco_paciente";
...
<meta charset="UTF-8">
  ...
  <body>
	...
	<form method = "POST" action = "grafico_doenca.php">
		<p><div class="form-group">
            <div class="col-md-6 offset-md-3">
				...
				<option value = "<?php echo $row_cidade['cida_ende_paci'];?>"><?php echo $row_cidade['cida_ende_paci'];}?></option>
				</select>
            </div>
        </div></p>
