...
$select_edicao = "SELECT paciente_internado.pk_paci_inte,
						 endereco_paciente_internado.pk_ende_paci_inte,
						 ...
						 AND paciente_internado.pk_paci_inte = '$pk'";
...
<meta charset="UTF-8">
  ...
  <body>
	...
	<form method = "POST" action = "valida_edicao_uti.php">
		<p><div class="form-group">
            <div class="col-md-6 offset-md-3">
				<input class="form-control form-control-sm" type="hidden" name = "pk_paci" value = "<?php echo $row_paciente['pk_paci_inte'];?>"></p>
            </div>
        </div></p>
		
		<p><div class="form-group">
            <div class="col-md-6 offset-md-3">
				<input class="form-control form-control-sm" type="hidden" name = "pk_ende_paci" value = "<?php echo $row_paciente['pk_ende_paci_inte'];?>"></p>
            </div>
        </div></p>
		<p><div class="form-group">
            <div class="col-md-6 offset-md-3">
                 <p class="text-forms">NOME:<br>
                <input class="form-control form-control-sm" type="text" name = "name" placeholder="Nome" value = "<?php echo $row_paciente['nome_paci_inte'];?>"></p>
            </div>
        </div></p>
		...
		<p><div class="form-group">
            <div class="col-md-6 offset-md-3">
                ...
                <input class="form-control form-control-sm" type = "text" onkeypress="$(this).mask('000.000.000-00');" name = "cpf" placeholder="CPF" value = "<?php echo $row_paciente['cpf_paci_inte'];?>"></p>
            </div>
        </div></p>
		...
		<p><div class="form-group">
            <div class="col-md-6 offset-md-3">
                ...
                <input class="form-control form-control-sm" type = "text" onkeypress="$(this).mask('(00) 0000-00009')" name = "fone" placeholder="Telefone" value = "<?php echo $row_paciente['fone_paci_inte'];?>"></p>
            </div>
        </div></p>
		...
		<p><div class="form-group">
            <div class="col-md-6 offset-md-3">
                ...
                <input class="form-control form-control-sm" type="date" name = "data" placeholder="Data" value = "<?php echo $row_paciente['data_entr_paci_inte'];?>"></p>
            </div>
        </div></p>
		...
		<p><div class="form-group">
            <div class="col-md-6 offset-md-3">
                ...
                <input class="form-control form-control-sm" type="text" name = "address" placeholder="Endereço" value = "<?php echo $row_paciente['logr_ende_paci_inte'];?>"></p>
            </div>
        </div></p>
		...
		<p><div class="form-group">
            <div class="col-md-6 offset-md-3">
                ...
                <input class="form-control form-control-sm" type="text" name = "num" placeholder="Número" value = "<?php echo $row_paciente['nume_ende_paci_inte'];?>"></p>
            </div>
        </div></p>
		...
		<p><div class="form-group">
            <div class="col-md-6 offset-md-3">
                ...
                <input class="form-control form-control-sm" type="text" name = "bairro" placeholder="Bairro" value = "<?php echo $row_paciente['bair_ende_paci_inte'];?>"></p>
            </div>
        </div></p>
		...
		<p><div class="form-group">
            <div class="col-md-6 offset-md-3">
                ...
                <input class="form-control form-control-sm" type = "text" onkeypress="$(this).mask('00000-000')" name = "cep" placeholder="CEP" value = "<?php echo $row_paciente['cep_ende_paci_inte'];?>"></p>
            </div>
        </div></p>
		...
		<p><div class="form-group">
            <div class="col-md-6 offset-md-3">
                ...
                <input class="form-control form-control-sm" type="text" name = "city" placeholder="Cidade" value = "<?php echo $row_paciente['cida_ende_paci_inte'];?>"></p>
            </div>
        </div></p>
		...
		<p><div class="form-group">
            <div class="col-md-6 offset-md-3">
              <p class="text-forms">ESTADO:<br>
				<select class="form-select" id="estado" name="estado" value = "<?php echo $row_paciente['uf_ende_paci_inte'];}?>"> 
		...
		<p><div class="form-group">
            <div class="col-md-6 offset-md-3">
              <p class="text-forms">SITTUAÇÂO DO PACIENTE:<br>
                <select class="form-select" id="estado_paciente" name="estado_paciente" value = "<?php echo $row_paciente['esta_doen'];?>"> 
